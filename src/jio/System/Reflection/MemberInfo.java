...
public abstract class MemberInfo implements ICustomAttributeProvider, _MemberInfo {
  ...
  public void GetTypeInfo(java.lang.Long iTInfo, java.lang.Long lcid, java.lang.Integer ppTInfo) {
    try {
      javonetHandle
          .explicitInterface("_MemberInfo")
          .invoke("System.Runtime.InteropServices._MemberInfo.GetTypeInfo", iTInfo, lcid, ppTInfo);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public void GetIDsOfNames(
    ...
    try {
      javonetHandle
          .explicitInterface("_MemberInfo")
          .invoke(
              "System.Runtime.InteropServices._MemberInfo.GetIDsOfNames",
              riid,
              rgszNames,
              cNames,
              lcid,
  ...
  public jio.System.Type GetType() {
    try {
      Object res =
          javonetHandle
              .explicitInterface("_MemberInfo")
              .invoke("System.Runtime.InteropServices._MemberInfo.GetType");
