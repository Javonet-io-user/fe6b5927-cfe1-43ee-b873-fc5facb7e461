...
public abstract class Type extends MemberInfo
  ...
  public void GetTypeInfoCount(AtomicReference<java.lang.Long> pcTInfo) {
    try {
      javonetHandle
          .explicitInterface("_Type")
          .invoke(
              "System.Runtime.InteropServices._Type.GetTypeInfoCount",
  ...
  public void GetTypeInfo(java.lang.Long iTInfo, java.lang.Long lcid, java.lang.Integer ppTInfo) {
    try {
      javonetHandle
          .explicitInterface("_Type")
          .invoke("System.Runtime.InteropServices._Type.GetTypeInfo", iTInfo, lcid, ppTInfo);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public void GetIDsOfNames(
    ...
    try {
      javonetHandle
          .explicitInterface("_Type")
          .invoke(
              "System.Runtime.InteropServices._Type.GetIDsOfNames",
              riid,
              rgszNames,
              cNames,
              lcid,
  ...
  public void Invoke(
    ...
    try {
      javonetHandle
          .explicitInterface("_Type")
          .invoke(
              "System.Runtime.InteropServices._Type.Invoke",
              dispIdMember,
              riid,
              lcid,
              wFlags,
